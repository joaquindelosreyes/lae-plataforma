...
pool.query(`
  ...
  ALTER TABLE operaciones ADD COLUMN IF NOT EXISTS tipo_impuesto_desc VARCHAR(100);
  ALTER TABLE operaciones ADD COLUMN IF NOT EXISTS pct_impuesto NUMERIC DEFAULT 0;
  ALTER TABLE operaciones ADD COLUMN IF NOT EXISTS tipo_impuesto2_desc VARCHAR(100);
  ALTER TABLE operaciones ADD COLUMN IF NOT EXISTS pct_impuesto2 NUMERIC DEFAULT 0;
`).catch(() => {});
  ...
  async crear(data) {
    ...
    const { rows } = await pool.query(`
      INSERT INTO operaciones (
        ...
        tipo_impuesto_desc, pct_impuesto, tipo_impuesto2_desc, pct_impuesto2
      ) VALUES (
    ...
    `, [
      ...
      data.tipo_impuesto_desc || null, data.pct_impuesto || 0, data.tipo_impuesto2_desc || null, data.pct_impuesto2 || 0
    ]);
    return rows[0];
  },
